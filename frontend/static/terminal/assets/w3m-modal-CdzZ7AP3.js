import{e3 as k,eC as le,cZ as c,c$ as pe,cL as v,cM as V,cP as f,cQ as g,cR as d,cO as l,dr as $,d8 as H,ds as u,cN as me,d4 as w,cT as B,dp as U,ep as fe,e9 as F,d1 as K,e0 as A,dc as M,cW as we,c_ as E,e5 as z,em as oe,dq as be,cV as ce,eD as ge,eE as ye}from"./index-T6qbGwsI.js";import{P as D}from"./index-Dcyul_0f.js";import{S as ve}from"./SwapController-D64YMDBT.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
