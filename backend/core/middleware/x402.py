...
_PAID_ROUTES: dict[str, dict] = {
    ...
    # --- Economic Bucket 1: $0.02 (High-Volume / Metadata / Discovery) ---
    "GET:/api/v1/agents":                               {"price_usdc": 0.02, "name": "Workforce Registry Directory", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/cappo/.well-known/capability-beacon-keys": {"price_usdc": 0.02, "name": "Published Beacon Issuer Keys", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/v1/capability/packages":                      {"price_usdc": 0.02, "name": "Capability Package Catalog", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/benchmarks/leaderboard":               {"price_usdc": 0.02, "name": "Benchmark Provider Array", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/v1/vnp/leaderboard":                          {"price_usdc": 0.02, "name": "VNP Rankings", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/v1/vnp/validators":                           {"price_usdc": 0.02, "name": "Validator Registry", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/v1/vnp/incidents":                            {"price_usdc": 0.02, "name": "Protocol Incidents", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/v1/vnp/metrics":                              {"price_usdc": 0.02, "name": "Measurement Payload", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/platform/pulse":                       {"price_usdc": 0.02, "name": "Platform Pulse Telemetry", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/gpc/stats":                            {"price_usdc": 0.02, "name": "Plan/Run Decision Totals", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/.well-known/x402":                            {"price_usdc": 0.02, "name": "Payment Discovery Document", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/pricing":                              {"price_usdc": 0.02, "name": "Pricing Response", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/agents/{id}/certificate":              {"price_usdc": 0.02, "name": "Certificate Metadata", "free_daily": 0, "category": "1", "unit": "per query"},
    "GET:/api/v1/agents/{id}/lifecycle":                {"price_usdc": 0.02, "name": "Lifecycle State", "free_daily": 0, "category": "1", "unit": "per query"},

    # --- Economic Bucket 2: $0.15 (Verification / State / Audit) ---
    "POST:/api/cappo/v1/capability/beacons/verify":     {"price_usdc": 0.15, "name": "Beacon Signature Verification", "free_daily": 0, "category": "2", "unit": "per verification"},
    "GET:/v1/audit/ledger":                             {"price_usdc": 0.15, "name": "Audit Ledger Entries", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/v1/audit/verify":                             {"price_usdc": 0.15, "name": "Ledger Verification Result", "free_daily": 0, "category": "2", "unit": "per verification"},
    "GET:/api/v1/ledger/agents/{id}":                   {"price_usdc": 0.15, "name": "Agent Ledger Entries", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/api/v1/ledger/agents/{id}/verify":            {"price_usdc": 0.15, "name": "Agent Chain Verification Result", "free_daily": 0, "category": "2", "unit": "per verification"},
    "POST:/api/v1/x402/verify":                         {"price_usdc": 0.15, "name": "x402 Payment Verification", "free_daily": 0, "category": "2", "unit": "per verification"},
    "GET:/api/v1/x402/{receipt_id}/proof":              {"price_usdc": 0.15, "name": "x402 Receipt Proof", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/api/cappo/v1/capability/beacons":             {"price_usdc": 0.15, "name": "Signed Capability Beacon Set", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/v1/capability/mounts/{mount_id}":             {"price_usdc": 0.15, "name": "Persisted Mount Lifecycle Status", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/v1/runs":                                     {"price_usdc": 0.15, "name": "Run EI/EAT Fields", "free_daily": 0, "category": "2", "unit": "per query"},
    "GET:/v1/governance/v2/quarantine":                 {"price_usdc": 0.15, "name": "Quarantine Queue", "free_daily": 0, "category": "2", "unit": "per query"},
    "POST:/v1/identities/{execution_id}/revoke":        {"price_usdc": 0.15, "name": "Revocation State", "free_daily": 0, "category": "2", "unit": "per revocation"},
    "POST:/v1/capability/mounts/{mount_id}/terminate":  {"price_usdc": 0.15, "name": "Mount Termination Decision", "free_daily": 0, "category": "2", "unit": "per termination"},

    # --- Economic Bucket 3: $1.00+ (Consequential Execution / Planning / Governance) ---
    "POST:/v1/capability/mounts":                       {"price_usdc": 1.00, "name": "Mount Decision and Token Descriptor", "free_daily": 0, "category": "3", "unit": "per mount"},
    "POST:/v1/capability/mounts/{mount_id}/actions":    {"price_usdc": 1.00, "name": "Action Allow or Deny Decision", "free_daily": 0, "category": "3", "unit": "per action"},
    "POST:/api/v1/gpc/compile":                         {"price_usdc": 1.50, "name": "Plan Graph and Proof Hash", "free_daily": 0, "category": "3", "unit": "per compile"},
    "POST:/v1/governance/v2/assess":                    {"price_usdc": 1.00, "name": "Governance Assessment", "free_daily": 0, "category": "3", "unit": "per assessment"},
