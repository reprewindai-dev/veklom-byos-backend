...
# Get token
req1 = urllib.request.Request("http://localhost:8088/api/v1/auth/eval-session", method="POST")
...
# Get provider status
req2 = urllib.request.Request("http://localhost:8088/api/v1/providers/routing/status")
