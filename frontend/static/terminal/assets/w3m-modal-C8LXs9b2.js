import{cW as v,cQ as f,cR as a,cO as w,ds as d,dr as q}from"./index-T6qbGwsI.js";import{w as ve,s as fe,a as ge,p as be,M as g,S as re,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-PiOTx6qC.js";import{c as u,U as We}from"./index-B80Mz-UZ.js";import"./index.es-DSvFD0Iu.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
...
`;var Ae=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let Q=class extends f{render(){return a`<slot></slot>`}};Q.styles=[P,$e];Q=Ae([u("wui-card")],Q);const Te=v`
  :host {
    display: flex;
    align-items: center;
