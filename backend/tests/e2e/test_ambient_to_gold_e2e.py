...
async def test_ambient_to_gold_loop():
    ...
    gateway.permissions_calculator.calculate_effective_permissions.return_value = {"can_execute": True}
    ...
    assert gold_response["result"]["output"]["data"] == "Capability executed successfully"
